...
/**
 * Created by shirukai on 2019-06-25 19:05
 * 基于NIO实现的Socket server
 */
                    ...
                    try {
                        ...
                        if (key.isReadable()) {
                            ...
                            if (readLength > 0) {
                                ...
                                RpcRequest rpcRequest = ObjectUtils.toObject(buffer.array());
                                System.out.println(rpcRequest);
                                client.write(ByteBuffer.wrap(("服务器已经接受消息：" + rpcRequest.toString()).getBytes()));
                            }
                        }
                        if (key.isWritable()) {
